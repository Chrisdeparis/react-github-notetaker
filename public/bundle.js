...
/***/ function(module, exports, __webpack_require__) {
	...
	var base = _reBase2['default'].createClass('https://react-git-notetaker.firebaseio.com/');
	  ...
	  _createClass(AddNote, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('input', { type: 'text', className: 'form-control', ref: 'note', placeholder: 'Add a new note' }),
	        _react2['default'].createElement(
	          'span',
